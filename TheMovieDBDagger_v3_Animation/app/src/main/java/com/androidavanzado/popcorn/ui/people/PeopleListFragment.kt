...
import com.androidavanzado.popcorn.ui.movies.MovieRecyclerViewAdapter
import com.androidavanzado.popcorn.ui.people.PeopleViewModel
...
class PeopleListFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.i("SHAREDVM", "Estoy en PeopleListFragment: ${sharedViewModel}")
    }
    ...
    override fun onCreateView(
        ...
        peopleViewModel.popularPeople.observe(viewLifecycleOwner, Observer { response ->
            Log.i("MOVIES", "sharedViewModel en PeopleListFragment: $sharedViewModel")
